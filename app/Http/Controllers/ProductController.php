...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->category !== null) {
            ...
            $created_at = Product::sortable()->paginate(15);
        } elseif ($keyword !== null) {
        ...
        return view('products.index', compact('products', 'category', 'categories', 'major_category_names', 'total_count', 'keyword', 'created_at'));
    }
